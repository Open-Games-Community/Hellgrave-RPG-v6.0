local config = {
    actionId = 43019, 
    bossName = "azazel [*****]",
    bossPosition = Position(29242, 31754, 11), 
    bossArea = {
        fromPos = Position(29218, 31739, 11), 
        toPos = Position(29267, 31780, 11), 
        entrancePos = Position(29241, 31770, 11), 
        exitPosition = Position(31825, 32408, 8) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(29188, 31758, 11),
        Position(29187, 31758, 11),
        Position(29186, 31758, 11), 
        Position(29185, 31758, 11) 
    },
    attempts = {
        level = 550, 
        storage = 710012, 
        seconds = 14400 -- 2 hours
    },
    createTeleportPos = Position(29246, 31749, 11), 
    teleportToPosition = Position(31825, 32408, 8), 
    teleportRemoveSeconds = 200, 
    kickParticipantAfterSeconds = 200 * 10,
    leverIds = {1945, 1946} 
}
...
local demoniacRiftAzazel = Action()

function demoniacRiftAzazel.onUse(player, item, fromPos, target, toPos, isHotkey)
    local participants = {}
    ...
    boss:registerEvent("demoniacRiftAzazelDeath")
...
demoniacRiftAzazel:aid(config.actionId)
demoniacRiftAzazel:register()

local creatureEvent = CreatureEvent("demoniacRiftAzazelDeath")
