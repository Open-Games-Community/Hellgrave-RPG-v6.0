local config = {
    actionId = 43017, 
    bossName = "the reckoner [**]",
    bossPosition = Position(29659, 32218, 9), 
    bossArea = {
        fromPos = Position(29642, 32206, 9), 
        toPos = Position(29679, 32234, 9), 
        entrancePos = Position(29659, 32225, 9), 
        exitPosition = Position(31825, 32408, 8) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(29903, 32318, 9),
        Position(29903, 32319, 9),
        Position(29903, 32320, 9), 
        Position(29903, 32321, 9) 
    },
    attempts = {
        level = 450, 
        storage = 710010, 
    ...
    createTeleportPos = Position(29665, 32214, 9), 
...
local elderRiftSecond = Action()

function elderRiftSecond.onUse(player, item, fromPos, target, toPos, isHotkey)
    local participants = {}
    ...
    boss:registerEvent("elderRiftSecondSystemDeath")
...
elderRiftSecond:aid(config.actionId)
elderRiftSecond:register()

local creatureEvent = CreatureEvent("elderRiftSecondSystemDeath")
