...
local topLeftCorner = Position(29535, 32426, 9)
local bottomRightCorner = Position(29652, 32533, 9)
...
local riftCondsecond = GlobalEvent("riftCondMap1Second")

function riftCondsecond.onThink(interval)
...
riftCondsecond:interval(5000)
riftCondsecond:register()