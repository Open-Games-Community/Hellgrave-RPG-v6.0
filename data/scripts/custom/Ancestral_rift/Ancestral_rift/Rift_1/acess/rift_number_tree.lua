local config = {
    actionId = 43010, 
    bossName = "[unique] phantom explorer [1]",
    bossPosition = Position(29674, 32395, 9), 
    bossArea = {
        fromPos = Position(29658, 32387, 9), 
        toPos = Position(29690, 32409, 9), 
        entrancePos = Position(29674, 32405, 9), 
        exitPosition = Position(31825, 32408, 8) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(29882, 32483, 10),
        Position(29882, 32484, 10),
        Position(29882, 32485, 10), 
        Position(29882, 32486, 10) 
    },
    attempts = {
        level = 100, 
        storage = 710003, 
    ...
    createTeleportPos = Position(29686, 32398, 9), 
...
function riftNumberTreeAction.onUse(player, item, fromPos, target, toPos, isHotkey)
    ...
    boss:registerEvent("riftNumberTreeSystemDeath")
...
local creatureEvent = CreatureEvent("riftNumberTreeSystemDeath")
