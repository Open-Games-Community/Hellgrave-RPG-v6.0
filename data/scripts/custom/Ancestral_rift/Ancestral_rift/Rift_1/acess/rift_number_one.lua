local config = {
    actionId = 43008, 
    bossName = "[unique] lord of damnation [1]",
    bossPosition = Position(29633, 32396, 9), 
    bossArea = {
        fromPos = Position(29621, 32387, 9), 
        toPos = Position(29646, 32407, 9), 
        entrancePos = Position(29632, 32392, 9), 
        exitPosition = Position(31825, 32408, 8) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(29636, 32472, 9),
        Position(29636, 32473, 9),
        Position(29636, 32474, 9), 
        Position(29636, 32475, 9) 
    },
    attempts = {
        level = 100, 
        storage = 710001, 
    ...
    createTeleportPos = Position(29634, 32403, 9), 
...
local riftNumberOneAction = Action()

function riftNumberOneAction.onUse(player, item, fromPos, target, toPos, isHotkey)
    local participants = {}
    ...
    boss:registerEvent("riftNumberOneSystemDeath")
...
riftNumberOneAction:aid(config.actionId)
riftNumberOneAction:register()

local creatureEvent = CreatureEvent("riftNumberOneSystemDeath")
