local config = {
    actionId = 43011, 
    bossName = "[unique] face of abomination [1]",
    bossPosition = Position(29668, 32355, 9), 
    bossArea = {
        fromPos = Position(29655, 32348, 9), 
        toPos = Position(29680, 32372, 9), 
        entrancePos = Position(29668, 32366, 9), 
        exitPosition = Position(31825, 32408, 8) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(30152, 32417, 8),
        Position(30152, 32418, 8),
        Position(30152, 32419, 8), 
        Position(30152, 32420, 8) 
    },
    attempts = {
        level = 100, 
        storage = 710004, 
    ...
    createTeleportPos = Position(29662, 32358, 9), 
...
function riftNumberFourAction.onUse(player, item, fromPos, target, toPos, isHotkey)
    ...
    boss:registerEvent("riftNumberFourSystemDeath")
...
local creatureEvent = CreatureEvent("riftNumberFourSystemDeath")
