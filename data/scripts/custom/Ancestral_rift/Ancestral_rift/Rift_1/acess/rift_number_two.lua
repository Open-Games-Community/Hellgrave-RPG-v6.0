local config = {
    actionId = 43009, 
    bossName = "[unique] devilkin [1]",
    bossPosition = Position(29633, 32358, 9), 
    bossArea = {
        fromPos = Position(29619, 32346, 9), 
        toPos = Position(29645, 32369, 9), 
        entrancePos = Position(29633, 32367, 9), 
        exitPosition = Position(31825, 32408, 8) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(29712, 32458, 9),
        Position(29713, 32458, 9),
        Position(29714, 32458, 9), 
        Position(29715, 32458, 9) 
    },
    attempts = {
        level = 100, 
        storage = 710002, 
    ...
    createTeleportPos = Position(29631, 32350, 9), 
...
function riftNumberTwoAction.onUse(player, item, fromPos, target, toPos, isHotkey)
    ...
    boss:registerEvent("riftNumberTwoSystemDeath")
...
local creatureEvent = CreatureEvent("riftNumberTwoSystemDeath")
