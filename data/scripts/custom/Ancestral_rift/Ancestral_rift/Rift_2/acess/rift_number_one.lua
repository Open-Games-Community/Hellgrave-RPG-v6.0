local config = {
    actionId = 43012, 
    bossName = "[unique] spiner of lies [2]",
    bossPosition = Position(29978, 31947, 9), 
    bossArea = {
        fromPos = Position(29963, 31937, 9), 
        toPos = Position(29989, 31959, 9), 
        entrancePos = Position(29978, 31952, 9), 
        exitPosition = Position(31825, 32408, 8) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(29711, 31910, 9),
        Position(29711, 31911, 9),
        Position(29711, 31912, 9), 
        Position(29711, 31913, 9) 
    },
    attempts = {
        level = 100, 
        storage = 710005, 
    ...
    createTeleportPos = Position(29968, 31948, 9), 
...
function riftNumberOneAction.onUse(player, item, fromPos, target, toPos, isHotkey)
    ...
    boss:registerEvent("rift2NumberOneSystemDeath")
...
local creatureEvent = CreatureEvent("rift2NumberOneSystemDeath")
