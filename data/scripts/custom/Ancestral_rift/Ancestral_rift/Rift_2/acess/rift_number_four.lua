local config = {
    actionId = 43015, 
    bossName = "[unique] deepth eel [2]",
    bossPosition = Position(29936, 31949, 9), 
    bossArea = {
        fromPos = Position(29925, 31941, 9), 
        toPos = Position(29946, 31957, 9), 
        entrancePos = Position(29932, 31954, 9), 
        exitPosition = Position(31825, 32408, 8) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(30035, 31822, 9),
        Position(30035, 31823, 9),
        Position(30035, 31824, 9), 
        Position(30035, 31825, 9) 
    },
    attempts = {
        level = 100, 
        storage = 710007, 
    ...
    createTeleportPos = Position(29935, 31945, 9), 
...
function riftNumberFourAction.onUse(player, item, fromPos, target, toPos, isHotkey)
    ...
    boss:registerEvent("rift2NumberFourSystemDeath")
...
local creatureEvent = CreatureEvent("rift2NumberFourSystemDeath")
