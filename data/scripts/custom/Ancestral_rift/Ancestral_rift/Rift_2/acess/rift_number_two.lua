local config = {
    actionId = 43013, 
    bossName = "[unique] greedgallow [2]",
    bossPosition = Position(29977, 31913, 9), 
    bossArea = {
        fromPos = Position(29965, 31904, 9), 
        toPos = Position(29990, 31926, 9), 
        entrancePos = Position(29976, 31920, 9), 
        exitPosition = Position(31825, 32408, 8) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(29651, 31777, 8),
        Position(29651, 31778, 8),
        Position(29651, 31779, 8), 
        Position(29651, 31780, 8) 
    },
    attempts = {
        level = 100, 
        storage = 710006, 
    ...
    createTeleportPos = Position(29971, 31912, 9), 
...
local riftNumberTwoAction = Action()

function riftNumberTwoAction.onUse(player, item, fromPos, target, toPos, isHotkey)
    local participants = {}
    ...
    boss:registerEvent("rift2NumberTwoSystemDeath")
...
riftNumberTwoAction:aid(config.actionId)
riftNumberTwoAction:register()

local creatureEvent = CreatureEvent("rift2NumberTwoSystemDeath")
