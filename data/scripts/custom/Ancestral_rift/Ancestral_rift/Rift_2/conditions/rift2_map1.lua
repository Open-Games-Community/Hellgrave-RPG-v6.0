...
local topLeftCorner = Position(29431, 31866, 9)
local bottomRightCorner = Position(29721, 31947, 9)

local condition = Condition(CONDITION_DAZZLED, CONDITIONID_COMBAT)
...
local riftCond = GlobalEvent("riftCondMap1second")
