...
local topLeftCorner = Position(29728, 31886, 10)
local bottomRightCorner = Position(29880, 32091, 10)

local condition = Condition(CONDITION_FREEZING, CONDITIONID_COMBAT)
