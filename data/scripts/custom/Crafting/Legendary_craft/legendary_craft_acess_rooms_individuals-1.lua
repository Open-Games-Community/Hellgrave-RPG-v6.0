...
local config = {
    actionId = 41673, 
    bossName = "deer",
    bossPosition = Position(32407, 32258, 7), 
    bossArea = {
        fromPos = Position(29387, 31790, 11), 
        toPos = Position(29412, 31808, 11), 
        entrancePos = Position(29401, 31805, 11), 
        exitPosition = Position(29351, 31767, 11) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(29349, 31765, 11),
    },
    attempts = {
        level = 400, 
        storage = 501203, 
    ...
    createTeleportPos = Position(32204, 32300, 7), 
...
local legendaryRoomOne = Action()

function legendaryRoomOne.onUse(player, item, fromPos, target, toPos, isHotkey)
    local participants = {}
    ...
    boss:registerEvent("legendaryCraftOne")
...
legendaryRoomOne:aid(config.actionId)
legendaryRoomOne:register()
