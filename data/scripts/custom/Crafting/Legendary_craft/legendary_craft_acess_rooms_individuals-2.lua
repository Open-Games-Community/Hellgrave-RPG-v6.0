...
local config = {
    actionId = 41674, 
    bossName = "deer",
    bossPosition = Position(32408, 32263, 7), 
    bossArea = {
        fromPos = Position(29387, 31771, 11), 
        toPos = Position(29412, 31788, 11), 
        entrancePos = Position(29401, 31785, 11), 
        exitPosition = Position(29351, 31767, 11) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(29351, 31765, 11),
    },
    attempts = {
        level = 400, 
        storage = 501204, 
    ...
    createTeleportPos = Position(32193, 32297, 7), 
...
local legendaryRoomTwo = Action()

function legendaryRoomTwo.onUse(player, item, fromPos, target, toPos, isHotkey)
    local participants = {}
    ...
    boss:registerEvent("legendaryCraftTwo")
...
legendaryRoomTwo:aid(config.actionId)
legendaryRoomTwo:register()
