local AmberPick = Action()

local config = {
    [8637] = {text = {"The crystal is regenerating"}}, -- Blue Crystal
    [8633] = {break_chance = 40, loot_chance = 45, lower_tier = 8637,  -- Large Blue Crystal
    ...
    [42057] = {break_chance = 50, loot_chance = 75, lower_tier = 8633, -- Mega Blue Crystal
        normal_loot_table = { -- 80%
            [1] = {item_id = 7705, count = 1}, -- Magma Stone
            [2] = {item_id = 5089, count = 1}, -- Crystal Stone
			[3] = {item_id = 7736, count = 1}, -- Solar Stone
    ...
    [8634] = {break_chance = 40, loot_chance = 45, lower_tier = 8638, -- Large Cyan Crystal
        normal_loot_table = { -- 80%
            [1] = {item_id = 7705, count = 1}, -- Magma Stone
            [2] = {item_id = 5089, count = 1}, -- Crystal Stone
			[3] = {item_id = 7736, count = 1}, -- Solar Stone
    ...
    [42056] = {break_chance = 50, loot_chance = 75, lower_tier = 8634, -- Mega Cyan Crystal
        normal_loot_table = { -- 80%
            [1] = {item_id = 7705, count = 1}, -- Magma Stone
            [2] = {item_id = 5089, count = 1}, -- Crystal Stone
			[3] = {item_id = 7736, count = 1}, -- Solar Stone
    ...
    [8635] = {break_chance = 40, loot_chance = 45, lower_tier = 8639,  -- Large Red Crystal
        normal_loot_table = { -- 80%
            [1] = {item_id = 7705, count = 1}, -- Magma Stone
            [2] = {item_id = 5089, count = 1}, -- Crystal Stone
			[3] = {item_id = 7736, count = 1}, -- Solar Stone
    ...
    [42059] = {break_chance = 50, loot_chance = 75, lower_tier = 8635, -- Mega Red Crystal
        normal_loot_table = { -- 80%
            [1] = {item_id = 7705, count = 1}, -- Magma Stone
            [2] = {item_id = 5089, count = 1}, -- Crystal Stone
			[3] = {item_id = 7736, count = 1}, -- Solar Stone
    ...
    [8636] = {break_chance = 40, loot_chance = 45, lower_tier = 8640, -- Large Green Crystal
        normal_loot_table = { -- 80%
            [1] = {item_id = 7705, count = 1}, -- Magma Stone
            [2] = {item_id = 5089, count = 1}, -- Crystal Stone
			[3] = {item_id = 7736, count = 1}, -- Solar Stone
    ...
    [42058] = {break_chance = 50, loot_chance = 75, lower_tier = 8636, -- Mega Green Crystal
        normal_loot_table = { -- 80%
            [1] = {item_id = 7705, count = 1}, -- Magma Stone
            [2] = {item_id = 5089, count = 1}, -- Crystal Stone
			[3] = {item_id = 7736, count = 1}, -- Solar Stone
    ...
    [21637] = {break_chance = 40, loot_chance = 45, lower_tier = 21638, -- Large White Crystal
        normal_loot_table = { -- 80%
            [1] = {item_id = 7705, count = 1}, -- Magma Stone
            [2] = {item_id = 5089, count = 1}, -- Crystal Stone
			[3] = {item_id = 7736, count = 1}, -- Solar Stone
    ...
    [42060] = {break_chance = 50, loot_chance = 75, lower_tier = 21637, -- Mega White Crystal
        normal_loot_table = { -- 80%
            [1] = {item_id = 7705, count = 1}, -- Magma Stone
            [2] = {item_id = 5089, count = 1}, -- Crystal Stone
			[3] = {item_id = 7736, count = 1}, -- Solar Stone
...
function AmberPick.onUse(cid, item, fromPosition, itemEx, toPosition)
