...
local player_positions = {
    [1] = {fromPos = Position(32689, 33093, 6), toPos = Position(31736, 31998, 7)},
    [2] = {fromPos = Position(32689, 33094, 6), toPos = Position(31737, 31998, 7)},
    [3] = {fromPos = Position(32689, 33095, 6), toPos = Position(31738, 31998, 7)},
    [4] = {fromPos = Position(32689, 33096, 6), toPos = Position(31739, 31998, 7)}
}
