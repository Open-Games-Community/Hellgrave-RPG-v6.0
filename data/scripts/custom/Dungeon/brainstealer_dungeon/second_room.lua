local event = {
    monsters = {
        {"Afflicted Strider", "Cave Chimera", "Varnished Diremaw", "Dark Carnisylvan", "Eyeless Devourer", "Streaked Devourer"},
		{"Tremendous Tyrant", "Cave Chimera", "Hoodinion", "Venerable Girtablilu", "Venerable Girtablilu", "Bashmu", "Bashmu",}
		
    },
    spawnArea = {Position(31683, 32170, 13), Position(31697, 32183, 13)}, -- {top_Left_Corner, bottom_Right_Corner}
    leverIds = {1945, 1946}, -- left, right
    leverActionId = 38191,
    teleportTimer = 100, -- how long the teleport stays
    teleportDestination = Position(31712, 32157, 13), -- Teleport To the Mordragor Temple
