local event = {
    monsters = {
        {"Bashmu", "Bashmu", "Bashmu", "Juvenile Bashmu", "Juvenile Bashmu", "Carnisylvan Sapling", "Hulking Carnisylvan", "Poisonous Carnisylvan", "Poisonous Carnisylvan"}
    },
    spawnArea = {Position(31661, 32170, 13), Position(31674, 32183, 13)}, -- {top_Left_Corner, bottom_Right_Corner}
    leverIds = {1945, 1946}, -- left, right
    leverActionId = 38190,
    teleportTimer = 100, -- how long the teleport stays
    teleportDestination = Position(31690, 32157, 13), -- Teleport To the Mordragor Temple
