...
function firstWorldBoss.onStepIn(player, item, fromPosition)
    if player:getStorageValue(Storage.WorldBosses.Unlock.Viscidius) < 1 then
        ...
        return true
    elseif player:getStorageValue(Storage.WorldBosses.Unlock.Viscidius) == 1 or player:getStorageValue(Storage.WorldBosses.Unlock.Viscidius) == 2 then
