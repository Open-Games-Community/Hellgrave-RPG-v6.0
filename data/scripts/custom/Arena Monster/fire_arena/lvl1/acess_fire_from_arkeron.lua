local config = {
    ...
    participantsPos = {
        Position(32679, 33091, 6),
        Position(32680, 33091, 6),
        Position(32681, 33091, 6), 
        Position(32682, 33091, 6)
    },
    attempts = {
        level = 100, 
        storage = 720253, 
...
function firelvl1Action.onUse(player, item, fromPos, target, toPos, isHotkey)
    ...
    boss:registerEvent("fireFirstSystemDeathArkeron")
...
local creatureEvent = CreatureEvent("fireFirstSystemDeathArkeron")
