local event = {
    monsters = {
        {"vulcongra", "vulcongra", "infected weeper", "infected weeper"},                  -- wave 1
        {"cliff strider", "humongous fungus", "demon", "blightwalker", "cliff strider", "vexclaw", "hellflayer"},   -- wave 2 -- you can add infinite waves.
        {"weeper", "weeper", "lavafungus", "bashmu", "lavafungus", "lavaworm", "lavaworm"},            -- wave 3
        {"eyeless devourer", "grimeleech", "guzzlemaw", "demon", "demon", "weeper", "lavafungus", "cliff strider"},
        {"vexclaw", "vexclaw", "grimeleech", "demon", "weeper", "lavaworm", "lava golem", "lava golem"},
        {"bragrumol", "zavarash"} -- wave final. (boss?)
    },
    spawnArea = {Position(31939, 31946, 6), Position(31959, 31953, 6)}, -- {top_Left_Corner, bottom_Right_Corner}
