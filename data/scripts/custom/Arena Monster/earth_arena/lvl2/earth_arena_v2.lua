local event = {
    monsters = {
        {"Ripper Spectre", "Serpent Spawn", "Medusa", "Devourer", "Wereboar", "Faun", "Black knight", "Lizard High guard", "Waspoid", "Elite Spidris", "Kollos"},                  -- wave 1
        {"Exotic Cave Spider", "Hive Overseer", "Menacing Carnivor", "cave devourer", "Humorless Fungus", "Spitter", "Spitter", "Broken Shaper", "Eternal Guardian"},   -- wave 2 -- you can add infinite waves.
        {"Lizard Chosen", "Draken Abomination", "Draken Spellweaver", "Draken Elite", "Medusa", "Devourer", "Carniphila"},            -- wave 3
        {"Paiz the pauperizer", "Glooth Anemone", "Behemoth", "Hive Overseer", "Spidris Elite", "Spidris Elite"},
        {"Shadowpelt", "Hemming", "Armadile", "Ripper Spectre", "Draken Abomination", "Spidris Elite", "Humorless Fungus", "Broken Shaper"},
        {"The Enraged Thorn Knight"} -- wave final. (boss?)
    },
    spawnArea = {Position(31931, 31991, 6), Position(31951, 32006, 6)}, -- {top_Left_Corner, bottom_Right_Corner}
    leverIds = {1945, 1946}, -- left, right
    leverActionId = 38182,
    teleportTimer = 100, -- how long the teleport stays
    teleportDestination = Position(32215, 32268, 6), -- Teleport To the Mordragor Temple
