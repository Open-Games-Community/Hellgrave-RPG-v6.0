local event = {
    monsters = {
        {"Hydra", "Serpent Spawn", "bog raider", "Devourer", "Rot elemental", "rot elemental"},                  -- wave 1
        {"Exotic Cave Spider", "Orclops Doomhauler", "Spidris", "Earth Overlord", "giant spider"},   -- wave 2 -- you can add infinite waves.
        {"brimestone bug", "brimestone bug", "brimestone bug", "crawler", "Ogre savage", "Medusa", "Medusa", "Medusa", "Omnivora"},            -- wave 3
        {"Menacing Carnivor", "Menacing Carnivor", "Stone Rhino", "cave devourer", "Carniphila", "carniphila"},
        {"Medusa", "cave devourer", "Humorless Fungus", "Defiler", "Humorless Fungus", "Defiler", "Hydra", "Menacing Carnivor"},
        {"Weakened Shlorg"} -- wave final. (boss?)
    },
    spawnArea = {Position(31930, 31999, 7), Position(31959, 32008, 7)}, -- {top_Left_Corner, bottom_Right_Corner}
