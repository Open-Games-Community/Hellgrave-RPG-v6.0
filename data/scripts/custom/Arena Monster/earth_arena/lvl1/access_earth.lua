local config = {
    ...
    participantsPos = {
        Position(32211, 32274, 6),
        Position(32212, 32274, 6),
        Position(32213, 32274, 6), 
        Position(32214, 32274, 6)
    },
    attempts = {
        level = 100, 
        storage = 720250, 
...
function earthlv1Action.onUse(player, item, fromPos, target, toPos, isHotkey)
    ...
    boss:registerEvent("earthOneSystemDeath")
...
local creatureEvent = CreatureEvent("earthOneSystemDeath")
