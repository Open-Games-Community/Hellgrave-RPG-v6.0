local event = {
    monsters = {
        {"Ripper Spectre", "Ripper Spectre", "Juggernaut", "Medusa", "Draken Abomination", "Devourer", "Carniphila", "Carniphila", "Elite Spidris", "Kollos"},                  -- wave 1
        {"Cave Chimera", "Hoodinion", "Carnisylvan Sapling", "Hulking Carnisylvan", "Murmillion", "Mearidion", "Spidris Elite"},   -- wave 2 -- you can add infinite waves.
        {"Blemished Spawn", "Blemished Spawn", "Tazhadur", "Fleshslicer", "Medusa", "Cave Chimera", "Hulking Carnisylvan"},            -- wave 3
        {"Cave Chimera", "Ripper Spectre", "Hive Overseer", "Spidris Elite", "Blemished Spawn", "Chikhaton", "Humorless Fungus", "Draken Abomination"},
        {"Tiquandas Revenge", "Tremendous Tyrant", "Tremendous Tyrant", "Cave Chimera", "Glooth Horror", "Squid Warden"},
        {"Horadron"} -- wave final. (boss?)
    },
    spawnArea = {Position(31943, 31997, 5), Position(31960, 32005, 5)}, -- {top_Left_Corner, bottom_Right_Corner}
