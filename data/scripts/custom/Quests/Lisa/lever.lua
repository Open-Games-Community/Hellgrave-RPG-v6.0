local config = {
    actionId = 30030, 
    bossName = "lisa",
    bossPosition = Position(32054, 32626, 12), 
    bossArea = {
        fromPos = Position(32035, 32607, 12), 
        toPos = Position(32070, 32641, 12), 
        entrancePos = Position(32053, 32620, 12), 
        exitPosition = Position(32028, 32665, 12) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(32030, 32664, 12),
        Position(32029, 32664, 12),
        Position(32028, 32664, 12), 
        Position(32027, 32664, 12) 
    },
    attempts = {
        level = 150, 
        storage = 720011, 
    ...
    createTeleportPos = Position(32054, 32633, 12), 
    teleportToPosition = Position(32028, 32665, 12), 
...
local lisaAction = Action()

function lisaAction.onUse(player, item, fromPos, target, toPos, isHotkey)
    local participants = {}
    ...
    boss:registerEvent("lisaSystemDeath")
...
lisaAction:aid(config.actionId)
lisaAction:register()

local creatureEvent = CreatureEvent("lisaSystemDeath")
