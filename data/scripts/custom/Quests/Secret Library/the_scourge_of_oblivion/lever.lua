local config = {
    ...
    bossPosition = Position(30175, 33542, 9), 
    bossArea = {
        fromPos = Position(30161, 33529, 9), 
        toPos = Position(30188, 33556, 9), 
        entrancePos = Position(30149, 33517, 9), 
        exitPosition = Position(30123, 33547, 9) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(30125, 33550, 9),
        Position(30125, 33551, 9),
        Position(30125, 33552, 9), 
        Position(30125, 33549, 9),
        Position(30125, 33548, 9),
        Position(30126, 33550, 9),
        Position(30126, 33551, 9),
        Position(30126, 33552, 9),
        Position(30126, 33549, 9),
        Position(30126, 33548, 9)
    },
    attempts = {
        level = 200, 
        storage = 720118, 
    ...
    createTeleportPos = Position(30175, 33530, 9), 
    teleportToPosition = Position(30123, 33547, 9), 
