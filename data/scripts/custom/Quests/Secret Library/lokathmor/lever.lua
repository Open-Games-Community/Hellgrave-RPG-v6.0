local config = {
    actionId = 27103, 
    bossName = "lokathmor",
    bossPosition = Position(30231, 33587, 9), 
    bossArea = {
        fromPos = Position(30219, 33576, 9), 
        toPos = Position(30240, 33595, 9), 
        entrancePos = Position(30229, 33592, 9), 
        exitPosition = Position(30202, 33645, 9) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(30201, 33647, 9),
        Position(30202, 33647, 9),
        Position(30203, 33647, 9), 
        Position(30204, 33647, 9),
        Position(30205, 33647, 9)
    },
    attempts = {
        level = 200, 
        storage = 720016, 
    ...
    createTeleportPos = Position(30231, 33594, 9), 
    teleportToPosition = Position(30202, 33645, 9), 
