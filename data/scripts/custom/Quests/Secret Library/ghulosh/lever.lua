local config = {
    actionId = 27102, 
    bossName = "ghulosh",
    bossPosition = Position(30236, 33618, 9), 
    bossArea = {
        fromPos = Position(30225, 33609, 9), 
        toPos = Position(30245, 33627, 9), 
        entrancePos = Position(30235, 33625, 9), 
        exitPosition = Position(30228, 33669, 9) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(30227, 33671, 9),
        Position(30228, 33671, 9),
        Position(30229, 33671, 9), 
        Position(30230, 33671, 9),
        Position(30231, 33671, 9)
    },
    attempts = {
        level = 200, 
        storage = 720214, 
    ...
    createTeleportPos = Position(30235, 33627, 9), 
    teleportToPosition = Position(30228, 33669, 9), 
