local config = {
    actionId = 27101, 
    bossName = "gorzindel",
    bossPosition = Position(30167, 33617, 9), 
    bossArea = {
        fromPos = Position(30152, 33602, 9), 
        toPos = Position(30180, 33629, 9), 
        entrancePos = Position(30166, 33621, 9), 
        exitPosition = Position(30229, 33645, 9) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(30227, 33647, 9),
        Position(30228, 33647, 9),
        Position(30229, 33647, 9), 
        Position(30230, 33647, 9),
        Position(30231, 33647, 9)
    },
    attempts = {
        level = 200, 
        storage = 720015, 
    ...
    createTeleportPos = Position(30167, 33624, 9), 
    teleportToPosition = Position(30229, 33645, 9), 
