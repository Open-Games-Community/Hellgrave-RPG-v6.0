local config = {
    actionId = 27104, 
    bossName = "mazzinor",
    bossPosition = Position(30204, 33618, 9), 
    bossArea = {
        fromPos = Position(30193, 33608, 9), 
        toPos = Position(30214, 33627, 9), 
        entrancePos = Position(30203, 33624, 9), 
        exitPosition = Position(30202, 33669, 9) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(30201, 33671, 9),
        Position(30202, 33671, 9),
        Position(30203, 33671, 9), 
        Position(30204, 33671, 9),
        Position(30205, 33671, 9)
    },
    attempts = {
        level = 200, 
        storage = 720017, 
    ...
    createTeleportPos = Position(30204, 33626, 9), 
    teleportToPosition = Position(30202, 33669, 9), 
