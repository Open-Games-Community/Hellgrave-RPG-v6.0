local config = {
    actionId = 30038, 
    bossName = "ushuriel",
    bossPosition = Position(32602, 32106, 13), 
    bossArea = {
        fromPos = Position(32600, 32105, 13), 
        toPos = Position(32607, 32111, 13), 
        entrancePos = Position(32603, 32110, 13), 
        exitPosition = Position(32596, 32111, 13) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(32595, 32115, 13), 
        Position(32595, 32114, 13), 
        Position(32595, 32113, 13), 
        Position(32595, 32112, 13) 
    },
    attempts = {
        level = 100,
        storage = 720002, 
    ...
    createTeleportPos = Position(32600, 32105, 13), 
    teleportToPosition = Position(32596, 32111, 13), 
...
function action.onUse(player, item, fromPos, target, toPos, isHotkey)
    ...
    boss:registerEvent("ushurielSystemDeath")
...
local creatureEvent = CreatureEvent("ushurielSystemDeath")
