local config = {
    actionId = 42585, 
    bossName = "duke krule",
    bossPosition = Position(32345, 31524, 8), 
    bossArea = {
        fromPos = Position(32334, 31514, 8), 
        toPos = Position(32356, 31535, 8), 
        entrancePos = Position(32344, 31531, 8), 
        exitPosition = Position(32345, 31549, 8) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(32344, 31546, 8),
        Position(32345, 31546, 8),
        Position(32346, 31546, 8), 
        Position(32347, 31546, 8),
        Position(32348, 31546, 8)
    },
    attempts = {
        level = 100, 
        storage = 720026, 
    ...
    createTeleportPos = Position(32345, 31534, 8), 
    teleportToPosition = Position(32345, 31549, 8), 
