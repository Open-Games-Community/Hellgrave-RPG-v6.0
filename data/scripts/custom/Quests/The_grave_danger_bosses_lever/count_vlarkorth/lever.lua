local config = {
    ...
    bossPosition = Position(32345, 31490, 8), 
    bossArea = {
        fromPos = Position(32334, 31480, 8), 
        toPos = Position(32355, 31500, 8), 
        entrancePos = Position(32345, 31497, 8), 
        exitPosition = Position(32345, 31463, 8) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(32344, 31466, 8),
        Position(32345, 31466, 8),
        Position(32346, 31466, 8), 
        Position(32348, 31466, 8),
        Position(32348, 31466, 8)
    },
    attempts = {
        level = 100, 
    ...
    createTeleportPos = Position(32345, 31499, 8), 
    teleportToPosition = Position(32345, 31463, 8), 
