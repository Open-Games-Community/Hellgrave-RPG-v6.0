local config = {
    ...
    bossPosition = Position(32312, 31523, 8), 
    bossArea = {
        fromPos = Position(32301, 31516, 8), 
        toPos = Position(32323, 31535, 8), 
        entrancePos = Position(32313, 31533, 8), 
        exitPosition = Position(32312, 31549, 8) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(32311, 31546, 8),
        Position(32312, 31546, 8),
        Position(32313, 31546, 8), 
        Position(32314, 31546, 8),
        Position(32315, 31546, 8)
    },
    attempts = {
        level = 100, 
        storage = 720841, 
    ...
    createTeleportPos = Position(32313, 31534, 8), 
    teleportToPosition = Position(32312, 31549, 8), 
