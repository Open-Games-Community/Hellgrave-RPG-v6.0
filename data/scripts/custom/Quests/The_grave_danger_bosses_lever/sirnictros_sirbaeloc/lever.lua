local config = {
    actionId = 42583, 
    bossName = "sir baeloc",
    bossPosition = Position(32312, 31492, 8), 
    bossArea = {
        fromPos = Position(32301, 31482, 8), 
        toPos = Position(32324, 31503, 8), 
        entrancePos = Position(32312, 31488, 8), 
        exitPosition = Position(32315, 31464, 8) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(32313, 31466, 8),
        Position(32314, 31466, 8),
        Position(32315, 31466, 8), 
        Position(32316, 31466, 8),
        Position(32317, 31466, 8)
    },
    attempts = {
        level = 100, 
        storage = 720130, 
    ...
    createTeleportPos = Position(32312, 31502, 8), 
    teleportToPosition = Position(32315, 31464, 8), 
