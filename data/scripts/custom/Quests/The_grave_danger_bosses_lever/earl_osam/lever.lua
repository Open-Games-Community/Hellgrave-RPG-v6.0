local config = {
    actionId = 42582, 
    bossName = "earl osam",
    bossPosition = Position(32377, 31491, 8), 
    bossArea = {
        fromPos = Position(32366, 31480, 8), 
        toPos = Position(32387, 31500, 8), 
        entrancePos = Position(32375, 31496, 8), 
        exitPosition = Position(32404, 31493, 8) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(32405, 31497, 8),
        Position(32406, 31497, 8),
        Position(32407, 31497, 8), 
        Position(32408, 31497, 8),
        Position(32409, 31497, 8)
    },
    attempts = {
        level = 100, 
        storage = 720027, 
    ...
    createTeleportPos = Position(32377, 31499, 8), 
    teleportToPosition = Position(32404, 31493, 8), 
