local config = {
    actionId = 42586, 
    bossName = "king zelos",
    bossPosition = Position(32332, 31599, 8), 
    bossArea = {
        fromPos = Position(32297, 31571, 8), 
        toPos = Position(32362, 31630, 8), 
        entrancePos = Position(32351, 31582, 8), 
        exitPosition = Position(32377, 31599, 8) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(32374, 31599, 8),
        Position(32374, 31598, 8),
        Position(32374, 31597, 8), 
        Position(32374, 31600, 8),
        Position(32374, 31601, 8),
        Position(32375, 31599, 8),
        Position(32375, 31598, 8),
        Position(32375, 31597, 8),
        Position(32375, 31600, 8),
        Position(32375, 31601, 8)
    },
    attempts = {
        level = 100, 
        storage = 720028, 
    ...
    createTeleportPos = Position(32332, 31608, 8), 
    teleportToPosition = Position(32377, 31599, 8), 
