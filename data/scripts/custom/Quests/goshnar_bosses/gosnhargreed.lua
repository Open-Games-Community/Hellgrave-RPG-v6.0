local config = {
    actionId = 42691, 
    bossName = "goshnar greed",
    bossPosition = Position(32492, 31633, 8), 
    bossArea = {
        fromPos = Position(32482, 31624, 8), 
        toPos = Position(32502, 31642, 8), 
        entrancePos = Position(32490, 31629, 8), 
        exitPosition = Position(32528, 31632, 8) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(32522, 31632, 8),
        Position(32523, 31632, 8),
        Position(32524, 31632, 8), 
        Position(32525, 31632, 8) 
    },
    attempts = {
        level = 300, 
        storage = 720009, 
    ...
    createTeleportPos = Position(32493, 31640, 8), 
    teleportToPosition = Position(32528, 31632, 8), 
...
local goshnarGreedAction = Action()

function goshnarGreedAction.onUse(player, item, fromPos, target, toPos, isHotkey)
    local participants = {}
    ...
    boss:registerEvent("goshnarGreedSystemDeath")
...
goshnarGreedAction:aid(config.actionId)
goshnarGreedAction:register()

local creatureEvent = CreatureEvent("goshnarGreedSystemDeath")
