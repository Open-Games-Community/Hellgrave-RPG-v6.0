local config = {
    actionId = 42692, 
    bossName = "goshnar megalomania",
    bossPosition = Position(32455, 31601, 8), 
    bossArea = {
        fromPos = Position(32444, 31591, 8), 
        toPos = Position(32465, 31610, 8), 
        entrancePos = Position(32454, 31596, 8), 
        exitPosition = Position(32428, 31601, 8) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(32422, 31601, 8),
        Position(32423, 31601, 8),
        Position(32424, 31601, 8), 
        Position(32425, 31601, 8) 
    },
    attempts = {
        level = 300, 
        storage = 720007, 
    ...
    createTeleportPos = Position(32459, 31609, 8), 
    teleportToPosition = Position(32428, 31601, 8), 
...
local goshnarMegalomaniaAction = Action()

function goshnarMegalomaniaAction.onUse(player, item, fromPos, target, toPos, isHotkey)
    local participants = {}
    ...
    boss:registerEvent("goshnarMegalomaniaSystemDeath")
...
goshnarMegalomaniaAction:aid(config.actionId)
goshnarMegalomaniaAction:register()

local creatureEvent = CreatureEvent("goshnarMegalomaniaSystemDeath")
