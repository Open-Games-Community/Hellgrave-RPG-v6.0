local config = {
    actionId = 42601, 
    bossName = "goshnar malice",
    bossPosition = Position(32455, 31565, 8), 
    bossArea = {
        fromPos = Position(32443, 31556, 8), 
        toPos = Position(32466, 31575, 8), 
        entrancePos = Position(32453, 31560, 8), 
        exitPosition = Position(32525, 31568, 8) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(32425, 31566, 8),
        Position(32426, 31566, 8),
        Position(32427, 31566, 8), 
        Position(32428, 31566, 8) 
    },
    attempts = {
        level = 300, 
        storage = 720006, 
    ...
    createTeleportPos = Position(32455, 31574, 8), 
    teleportToPosition = Position(32430, 31566, 8), 
...
local goshnarMaliceAction = Action()

function goshnarMaliceAction.onUse(player, item, fromPos, target, toPos, isHotkey)
    local participants = {}
    ...
    boss:registerEvent("goshnarMaliceSystemDeath")
...
goshnarMaliceAction:aid(config.actionId)
goshnarMaliceAction:register()

local creatureEvent = CreatureEvent("goshnarMaliceSystemDeath")
