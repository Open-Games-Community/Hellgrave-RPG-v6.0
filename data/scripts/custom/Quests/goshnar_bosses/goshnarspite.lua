local config = {
    actionId = 42419, 
    bossName = "goshnar spite",
    bossPosition = Position(32488, 31600, 8), 
    bossArea = {
        fromPos = Position(32473, 31587, 8), 
        toPos = Position(32501, 31611, 8), 
        entrancePos = Position(32487, 31596, 8), 
        exitPosition = Position(32525, 31601, 8) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(32520, 31601, 8),
        Position(32521, 31601, 8),
        Position(32522, 31601, 8), 
        Position(32523, 31601, 8) 
    },
    attempts = {
        level = 300, 
        storage = 720008, 
    ...
    createTeleportPos = Position(32489, 31607, 8), 
    teleportToPosition = Position(32525, 31601, 8), 
...
local goshnarSpiteAction = Action()

function goshnarSpiteAction.onUse(player, item, fromPos, target, toPos, isHotkey)
    local participants = {}
    ...
    boss:registerEvent("goshnarSpiteSystemDeath")
...
goshnarSpiteAction:aid(config.actionId)
goshnarSpiteAction:register()

local creatureEvent = CreatureEvent("goshnarSpiteSystemDeath")
