local config = {
    ...
    bossPosition = Position(32088, 32241, 6), 
    bossArea = {
        fromPos = Position(32075, 32237, 6), 
        toPos = Position(32100, 32260, 6), 
        entrancePos = Position(32086, 32256, 6), 
        exitPosition = Position(32087, 32263, 6) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(32087, 32262, 6),
        Position(32087, 32263, 6),
        Position(32087, 32264, 6), 
        Position(32087, 32265, 6) 
    },
    attempts = {
        level = 100, 
        storage = 720013, 
    ...
    createTeleportPos = Position(32087, 32259, 6), 
    teleportToPosition = Position(32087, 32263, 6), 
...
local scarlettEtzelAction = Action()

function scarlettEtzelAction.onUse(player, item, fromPos, target, toPos, isHotkey)
    local participants = {}
    ...
    boss:registerEvent("scarlettEtzelSystemDeath")
...
scarlettEtzelAction:aid(config.actionId)
scarlettEtzelAction:register()

local creatureEvent = CreatureEvent("scarlettEtzelSystemDeath")
