local config = {
    ...
    bossPosition = Position(32808, 31812, 8), 
    bossArea = {
        fromPos = Position(32798, 31802, 8), 
        toPos = Position(32818, 31824, 8), 
        entrancePos = Position(32807, 31816, 8), 
        exitPosition = Position(32840, 31816, 8) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(32835, 31816, 8),
        Position(32836, 31816, 8),
        Position(32837, 31816, 8), 
        Position(32838, 31816, 8)
    },
    attempts = {
        level = 200, 
        storage = 720019, 
    ...
    createTeleportPos = Position(32807, 31821, 8), 
    teleportToPosition = Position(32840, 31816, 8), 
