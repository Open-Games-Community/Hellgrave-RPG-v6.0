local config = {
    ...
    bossPosition = Position(32805, 31848, 8), 
    bossArea = {
        fromPos = Position(32791, 31837, 8), 
        toPos = Position(32816, 31859, 8), 
        entrancePos = Position(32803, 31851, 8), 
        exitPosition = Position(32833, 31849, 8) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(32832, 31847, 8),
        Position(32833, 31847, 8),
        Position(32834, 31847, 8), 
        Position(32835, 31847, 8)
    },
    attempts = {
        level = 200, 
        storage = 720022, 
    ...
    createTeleportPos = Position(32804, 31857, 8), 
    teleportToPosition = Position(32833, 31849, 8), 
