local config = {
    ...
    bossPosition = Position(32901, 31814, 8), 
    bossArea = {
        fromPos = Position(32887, 31804, 8), 
        toPos = Position(32916, 31826, 8), 
        entrancePos = Position(32901, 31820, 8), 
        exitPosition = Position(32875, 31814, 8) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(32868, 31814, 8),
        Position(32869, 31814, 8),
        Position(32870, 31814, 8), 
        Position(32870, 31814, 8)
    },
    attempts = {
        level = 200, 
    ...
    createTeleportPos = Position(32902, 31825, 8), 
    teleportToPosition = Position(32875, 31814, 8), 
