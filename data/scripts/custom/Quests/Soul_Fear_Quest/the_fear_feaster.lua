local config = {
    ...
    bossPosition = Position(32807, 31779, 8), 
    bossArea = {
        fromPos = Position(32796, 31771, 8), 
        toPos = Position(32816, 31789, 8), 
        entrancePos = Position(32806, 31781, 8), 
        exitPosition = Position(32835, 31781, 8) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(32830, 31781, 8),
        Position(32831, 31781, 8),
        Position(32832, 31781, 8), 
        Position(32833, 31781, 8)
    },
    attempts = {
        level = 200, 
        storage = 720020, 
    ...
    createTeleportPos = Position(32808, 31786, 8), 
    teleportToPosition = Position(32835, 31781, 8), 
