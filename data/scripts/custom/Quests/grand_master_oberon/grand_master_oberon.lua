local config = {
    ...
    bossPosition = Position(31861, 32208, 9), 
    bossArea = {
        fromPos = Position(31851, 32200, 9), 
        toPos = Position(31873, 32218, 9), 
        entrancePos = Position(31867, 32211, 9), 
        exitPosition = Position(31861, 32236, 9) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(31862, 32234, 9),
        Position(31862, 32235, 9),
        Position(31862, 32236, 9), 
        Position(31862, 32237, 9) 
    },
    attempts = {
        level = 100, 
        storage = 720010, 
    ...
    createTeleportPos = Position(31862, 32216, 9), 
    teleportToPosition = Position(31861, 32236, 9), 
...
local grandMasterOberonAction = Action()

function grandMasterOberonAction.onUse(player, item, fromPos, target, toPos, isHotkey)
    local participants = {}
    ...
    boss:registerEvent("grandMasterOberonSystemDeath")
...
grandMasterOberonAction:aid(config.actionId)
grandMasterOberonAction:register()

local creatureEvent = CreatureEvent("grandMasterOberonSystemDeath")
