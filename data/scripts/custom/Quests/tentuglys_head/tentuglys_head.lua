local config = {
    actionId = 42704, 
    bossName = "tentuglys boss",
    bossPosition = Position(31684, 32358, 7), 
    bossArea = {
        fromPos = Position(31664, 32350, 7), 
        toPos = Position(31699, 32368, 7), 
        entrancePos = Position(31684, 32362, 6), 
        exitPosition = Position(31689, 32395, 6) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(31684, 32395, 6),
        Position(31685, 32395, 6),
        Position(31686, 32395, 6), 
        Position(31687, 32395, 6)
    },
    attempts = {
        level = 200, 
        storage = 720023, 
    ...
    createTeleportPos = Position(31681, 32360, 7), 
    teleportToPosition = Position(31689, 32395, 6), 
...
local tentuglysAction = Action()

function tentuglysAction.onUse(player, item, fromPos, target, toPos, isHotkey)
    local participants = {}
    ...
    boss:registerEvent("tentuglysSystemDeath")
...
tentuglysAction:aid(config.actionId)
tentuglysAction:register()

local creatureEvent = CreatureEvent("tentuglysSystemDeath")
