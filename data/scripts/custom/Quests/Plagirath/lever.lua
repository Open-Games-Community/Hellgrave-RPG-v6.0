local config = {
    actionId = 30036, 
    bossName = "plagirath",
    bossPosition = Position(31949, 32368, 11), 
    bossArea = {
        fromPos = Position(31942, 32360, 11), 
        toPos = Position(31960, 32378, 11), 
        entrancePos = Position(31948, 32360, 11), 
        exitPosition = Position(31948, 32396, 11) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(31947, 32396, 11),
        Position(31948, 32396, 11),
        Position(31949, 32396, 11), 
        Position(31950, 32396, 11) 
    },
    attempts = {
        level = 300, 
        storage = 720003, 
    ...
    createTeleportPos = Position(31949, 32378, 11), 
    teleportToPosition = Position(31948, 32396, 11), 
...
local plagirAction = Action()

function plagirAction.onUse(player, item, fromPos, target, toPos, isHotkey)
    local participants = {}
    ...
    boss:registerEvent("plagirathSystemDeath")
...
plagirAction:aid(config.actionId)
plagirAction:register()

local creatureEvent = CreatureEvent("plagirathSystemDeath")
