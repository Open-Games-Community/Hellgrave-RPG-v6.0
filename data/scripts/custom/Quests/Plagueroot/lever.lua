local config = {
    actionId = 30032, 
    bossName = "plagueroot",
    bossPosition = Position(32153, 32668, 10), 
    bossArea = {
        fromPos = Position(32142, 32658, 10), 
        toPos = Position(32163, 32680, 10), 
        entrancePos = Position(32151, 32676, 10), 
        exitPosition = Position(32120, 32668, 10) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(32122, 32668, 10),
        Position(32121, 32668, 10),
        Position(32120, 32668, 10), 
        Position(32119, 32668, 10) 
    },
    attempts = {
        level = 150, 
        storage = 720012, 
    ...
    createTeleportPos = Position(32153, 32677, 10), 
    teleportToPosition = Position(32120, 32668, 10), 
