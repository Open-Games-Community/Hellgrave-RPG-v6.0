local config = {
    actionId = 30034, 
    bossName = "the welter",
    bossPosition = Position(31992, 32622, 9), 
    bossArea = {
        fromPos = Position(31981, 32612, 9), 
        toPos = Position(32000, 32631, 9), 
        entrancePos = Position(31992, 32625, 9), 
        exitPosition = Position(32010, 32609, 6) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(32010, 32613, 6),
        Position(32010, 32612, 6),
        Position(32010, 32611, 6), 
        Position(32010, 32610, 6)
    },
    attempts = {
        level = 100, 
        storage = 720024, 
    ...
    createTeleportPos = Position(31992, 32630, 9), 
    teleportToPosition = Position(32010, 32609, 6), 
