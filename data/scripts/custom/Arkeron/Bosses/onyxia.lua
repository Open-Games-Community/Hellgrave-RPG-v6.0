local config = {
    actionId = 43027, 
    bossName = "onyxia [*****]",
    bossPosition = Position(33164, 33236, 15), 
    bossArea = {
        fromPos = Position(33148, 33229, 15), 
        toPos = Position(33174, 33260, 15), 
        entrancePos = Position(33164, 33255, 15), 
        exitPosition = Position(33162, 33298, 15) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(33164, 33297, 15),
        Position(33164, 33298, 15),
        Position(33164, 33299, 15), 
        Position(33164, 33300, 15) 
    },
    attempts = {
        level = 500, 
        storage = 314007, 
    ...
    createTeleportPos = Position(33164, 33238, 15),
    teleportToPosition = Position(33162, 33298, 15), 
...
local bossOnyxia = Action()

function bossOnyxia.onUse(player, item, fromPos, target, toPos, isHotkey)
    local participants = {}
    ...
    boss:registerEvent("onyxiaDeath")
...
bossOnyxia:aid(config.actionId)
bossOnyxia:register()

local creatureEvent = CreatureEvent("onyxiaDeath")
