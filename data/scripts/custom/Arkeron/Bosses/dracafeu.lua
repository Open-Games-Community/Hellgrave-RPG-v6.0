local config = {
    actionId = 43025, 
    bossName = "dracafeu [*****]",
    bossPosition = Position(33328, 32949, 8), 
    bossArea = {
        fromPos = Position(33320, 32925, 8), 
        toPos = Position(33364, 32957, 8), 
        entrancePos = Position(33347, 32937, 8), 
        exitPosition = Position(33323, 32926, 9) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(33323, 32927, 9),
        Position(33322, 32926, 9),
        Position(33324, 32926, 9), 
        Position(33323, 32925, 9) 
    },
    attempts = {
        level = 500, 
        storage = 314005, 
    ...
    createTeleportPos = Position(33328, 32953, 8),
    teleportToPosition = Position(33323, 32926, 9), 
...
local bossDracafeu = Action()

function bossDracafeu.onUse(player, item, fromPos, target, toPos, isHotkey)
    local participants = {}
    ...
    boss:registerEvent("dracafeuDeath")
...
bossDracafeu:aid(config.actionId)
bossDracafeu:register()

local creatureEvent = CreatureEvent("dracafeuDeath")
