local config = {
    actionId = 43022, 
    bossName = "ultros [*****]",
    bossPosition = Position(32806, 33035, 9), 
    bossArea = {
        fromPos = Position(32790, 33022, 9), 
        toPos = Position(32823, 33049, 9), 
        entrancePos = Position(32777, 33031, 8), 
        exitPosition = Position(32780, 32982, 10) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(32780, 32981, 10),
        Position(32779, 32982, 10),
        Position(32781, 32982, 10), 
        Position(32780, 32983, 10) 
    },
    attempts = {
        level = 500, 
        storage = 314002, 
    ...
    createTeleportPos = Position(32799, 33032, 9), 
    teleportToPosition = Position(32780, 32982, 10), 
