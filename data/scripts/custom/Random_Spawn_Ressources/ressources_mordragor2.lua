local spawnMordragor = GlobalEvent("spawnRessourcesMordragor2")
local itemsList = { -- List of items and their quantities
    {itemId = 8640, quantity = 3},
    {itemId = 8639, quantity = 4},
    ...
    {itemId = 27373, quantity = 4},
    {itemId = 33161, quantity = 4},
}
...
STARTUP[#STARTUP + 1] = { -- Quest Stuff
    action = function()
        local fromPos = {x=32264, y=32324, z=7}
        local toPos = {x=32376, y=32450, z=7}
