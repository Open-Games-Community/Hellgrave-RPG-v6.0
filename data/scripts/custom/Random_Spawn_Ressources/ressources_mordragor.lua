local spawnMordragor = GlobalEvent("spawnRessourcesMordragor")
local itemsList = { -- List of items and their quantities
    ...
    {itemId = 27373, quantity = 8},
    {itemId = 33161, quantity = 5},
}
...
STARTUP[#STARTUP + 1] = { -- Quest Stuff
    action = function()
        local fromPos = {x=32388, y=32127, z=7}
        local toPos = {x=32552, y=32360, z=7}
