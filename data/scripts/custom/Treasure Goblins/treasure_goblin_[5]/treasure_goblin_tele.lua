local treasureFiveGoblin = CreatureEvent("treasureFiveGoblin")
local enemyNames = {
    [1] = "Treasure Goblin the fifth"
}
...
function treasureFiveGoblin.onKill(creature, target)
    ...
    local teleportSpawn = Position(32239, 32012, 11) -- Position for teleport to spawn
