local treasureThirstGoblin = CreatureEvent("treasureThirstGoblin")
local enemyNames = {
    [1] = "Treasure Goblin the third"
}
...
function treasureThirstGoblin.onKill(creature, target)
    ...
    local teleportSpawn = Position(32099, 32012, 11) -- Position for teleport to spawn
