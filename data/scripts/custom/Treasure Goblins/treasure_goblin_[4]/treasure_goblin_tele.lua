local treasureFourGoblin = CreatureEvent("treasureFourGoblin")
local enemyNames = {
    [1] = "Treasure Goblin the fourth"
}
...
function treasureFourGoblin.onKill(creature, target)
    ...
    local teleportSpawn = Position(32170, 32012, 11) -- Position for teleport to spawn
