local treasureOneGoblin = CreatureEvent("treasureOneGoblin")
local enemyNames = {
    [1] = "Treasure Goblin the first"
}
...
function treasureOneGoblin.onKill(creature, target)
    ...
    local teleportSpawn = Position(31958, 32010, 11) -- Position for teleport to spawn
