...
local shop = {
	{id=10072, buy=0, sell=70, name='necromancer relic'},
	{id=10074, buy=0, sell=20, name='relic of nature'},
	{id=2087, buy=0, sell=12, name='relic of venom'},
	{id=10096, buy=0, sell=70, name='elemental relic'},
	{id=10097, buy=0, sell=10, name='water relic'},
	{id=9676, buy=0, sell=5, name='fire artefact'},
	{id=9677, buy=0, sell=13, name='arch of riddles'},
	{id=11428, buy=0, sell=4, name='karma arch'},
	{id=9694, buy=0, sell=46, name='hells arch'},
	{id=9696, buy=0, sell=38, name='damnation ark'},
	{id=9697, buy=0, sell=25, name='orb of nature'},
	{id=9698, buy=0, sell=90, name='orb of misery'},
...
local function onSell(cid, item, subType, amount, ignoreCap, inBackpacks)
	...
	if not ignoreCap and player:getFreeCapacity() < ItemType(itemsTable[item].id):getWeight(amount) then
		...
		if player:addItem(41995, amount* itemsTable[item].sell, amount* itemsTable[item].sell) then
			return player:sendTextMessage(MESSAGE_TRADE,
						"Sell "..amount.."x "..itemsTable[item].name.." for "..amount* itemsTable[item].sell.." Dusts.")
end
return true
end
...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "Trade") then
		...
		npcHandler:say("You can sell your looted equipments for some Dusts.", cid)
	end
	return true
end
