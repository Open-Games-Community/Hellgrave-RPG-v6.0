...
local shop = { -- 2333 gps 1 Time Coin
	{id=27316, buy=15, sell=0, name='Goblin Gold Scroll'},
	{id=27318, buy=15, sell=0, name='Gathering Island Scroll'},
	{id=27321, buy=15, sell=0, name='Goblin Gem Scroll'},
	{id=27433, buy=30, sell=0, name='Big Experience Scroll'},
	{id=27434, buy=20, sell=0, name='Medium Experience Scroll'},
	{id=27435, buy=9, sell=0, name='Small Experience Scroll'},
	{id=27322, buy=43, sell=0, name='Vast Experience Scroll'},
	{id=27314, buy=65, sell=0, name='Enormous Experience Scroll'},
	{id=27317, buy=97, sell=0, name='Gigantic Experience Scroll'},
...
local function onSell(cid, item, subType, amount, ignoreCap, inBackpacks)
	...
	if not ignoreCap and player:getFreeCapacity() < ItemType(itemsTable[item].id):getWeight(amount) then
		...
		if player:addItem(26314, amount* itemsTable[item].sell, amount* itemsTable[item].sell) then
			return player:sendTextMessage(MESSAGE_TRADE,
						"Sell "..amount.."x "..itemsTable[item].name.." for "..amount* itemsTable[item].sell.." Time Coins.")
end
return true
end
...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "Trade") then
		...
		npcHandler:say("You can buy Experience Scrolls or Goblin Scrolls for Time Coins.", cid)
	end
	return true
end
