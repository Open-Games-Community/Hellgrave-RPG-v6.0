...
local shop = {
	{id=25951, buy=1, sell=0, name='parchment of ancient writings'},
	{id=25935, buy=1, sell=0, name='void essence'},
	{id=27605, buy=2, sell=0, name='chaos blood'},
	{id=23064, buy=2, sell=0, name='void chest'},
	{id=23063, buy=3, sell=0, name='caphras chest'},
	{id=25919, buy=100, sell=0, name='sword mark'},
	{id=25920, buy=100, sell=0, name='axe mark'},
	{id=25923, buy=100, sell=0, name='hammer mark'},
	{id=25924, buy=100, sell=0, name='distance mark'},
	{id=25927, buy=100, sell=0, name='wand mark'},
	{id=25928, buy=100, sell=0, name='rod mark'},
	{id=25931, buy=100, sell=0, name='equipment mark'},
...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "Trade") then
		...
		npcHandler:say("You can buy or sell with Arkeron Coins.", cid)
	end
	return true
end
