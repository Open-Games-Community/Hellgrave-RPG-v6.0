...
local shop = { -- 12500 gps 1 Crystal Token
	{id=27191, buy=8, sell=0, name='Soul Potion'},
	{id=41558, buy=16, sell=0, name='Strike Enhancement'},
	{id=41559, buy=8, sell=0, name='Sword Enhancement'},
	{id=41560, buy=8, sell=0, name='Axe Enhancement'},
	{id=41561, buy=8, sell=0, name='Club Enhancement'},
	{id=41562, buy=8, sell=0, name='Distance Enhancement'},
	{id=41563, buy=8, sell=0, name='Magic Enhancement'},
	{id=41564, buy=8, sell=0, name='Shield Enhancement'},
	{id=41565, buy=8, sell=0, name='Fishing Enhancement'},
	{id=41566, buy=16, sell=0, name='Strike Damage Enhancement'},
...
local function onSell(cid, item, subType, amount, ignoreCap, inBackpacks)
	...
	if not ignoreCap and player:getFreeCapacity() < ItemType(itemsTable[item].id):getWeight(amount) then
		...
		if player:addItem(27304, amount* itemsTable[item].sell, amount* itemsTable[item].sell) then
			return player:sendTextMessage(MESSAGE_TRADE,
						"Sell "..amount.."x "..itemsTable[item].name.." for "..amount* itemsTable[item].sell.." Crystal Tokens.")
end
return true
end
...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "Trade") then
		...
		npcHandler:say("You can buy some potions with Crystal Tokens.", cid)
	end
	return true
end
