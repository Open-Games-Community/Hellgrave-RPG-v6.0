...
local shop = { -- 18750 gps 1 Wind Token
	{id=10159, buy=40, sell=0, name='Forest Emblem'},
	{id=10166, buy=40, sell=0, name='Necromantic Emblem'},
	{id=10167, buy=40, sell=0, name='Damned Emblem'},
	{id=10170, buy=40, sell=0, name='Emblem of Blessing'},
	{id=10291, buy=40, sell=0, name='Emblem of the Sky'},
	{id=10292, buy=40, sell=0, name='Nature Emblem'},
	{id=10294, buy=40, sell=0, name='Fountain of Youth Emblem'},
...
local function onSell(cid, item, subType, amount, ignoreCap, inBackpacks)
	...
	if not ignoreCap and player:getFreeCapacity() < ItemType(itemsTable[item].id):getWeight(amount) then
		...
		if player:addItem(27310, amount* itemsTable[item].sell, amount* itemsTable[item].sell) then
			return player:sendTextMessage(MESSAGE_TRADE,
						"Sell "..amount.."x "..itemsTable[item].name.." for "..amount* itemsTable[item].sell.." Wind Tokens.")
end
return true
end
...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "Trade") then
		...
		npcHandler:say("You can buy some Emblems for Wind Tokens.", cid)
	end
	return true
end
