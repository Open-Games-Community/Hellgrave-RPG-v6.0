...
local shop = {
	{id=10119, buy=0, sell=8, name='supremacy relic'},
	{id=10071, buy=0, sell=1, name='mirror relic'},
	{id=10073, buy=0, sell=1, name='relic of benediction'},
	{id=10075, buy=0, sell=1, name='relic of cosmos'},
	{id=10089, buy=0, sell=2, name='relic of the sky'},
	{id=10090, buy=0, sell=20, name='magma relic'},
	{id=14350, buy=0, sell=5, name='enigma relic'},
	{id=10092, buy=0, sell=3, name='evil relic'},
	{id=18547, buy=0, sell=6, name='celestial relic'},
	{id=10099, buy=0, sell=45, name='divine relic'},
	{id=9693, buy=0, sell=5, name='arch of destruction'},
	{id=9699, buy=0, sell=6, name='curse of monolith'},
	{id=9735, buy=0, sell=6, name='dream catcher'},
...
local function onSell(cid, item, subType, amount, ignoreCap, inBackpacks)
	...
	if not ignoreCap and player:getFreeCapacity() < ItemType(itemsTable[item].id):getWeight(amount) then
		...
		if player:addItem(41670, amount* itemsTable[item].sell, amount* itemsTable[item].sell) then
			return player:sendTextMessage(MESSAGE_TRADE,
						"Sell "..amount.."x "..itemsTable[item].name.." for "..amount* itemsTable[item].sell.." Eldritch Crystals.")
end
return true
end
...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "Trade") then
		...
		npcHandler:say("You can sell your looted equipments for some Eldritch Crystals.", cid)
	end
	return true
end
