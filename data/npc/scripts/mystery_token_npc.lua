...
local shop = { -- 25000 gps 1 Mystery Token
	{id=9743, buy=9, sell=0, name='Cursed Chest'},
	{id=10028, buy=1, sell=0, name='Key of Cursed Chest'},
	{id=9744, buy=18, sell=0, name='Vengeance Chest'},
	{id=10031, buy=2, sell=0, name='Key of Vengeance Chest'},
	{id=10006, buy=30, sell=0, name='Damned Chest'},
	{id=14349, buy=3, sell=0, name='Key of Damned Chest'},
	{id=10026, buy=24, sell=0, name='Reliquary Chest'},
	{id=10046, buy=2, sell=0, name='Key of Reliquary Chest'},
}
...
local function onSell(cid, item, subType, amount, ignoreCap, inBackpacks)
	...
	if not ignoreCap and player:getFreeCapacity() < ItemType(itemsTable[item].id):getWeight(amount) then
		...
		if player:addItem(26323, amount* itemsTable[item].sell, amount* itemsTable[item].sell) then
			return player:sendTextMessage(MESSAGE_TRADE,
						"Sell "..amount.."x "..itemsTable[item].name.." for "..amount* itemsTable[item].sell.." Mystery Tokens.")
end
return true
end
...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "Trade") then
		...
		npcHandler:say("You can buy some Mystery Chests for Mystery Tokens.", cid)
	end
	return true
end
