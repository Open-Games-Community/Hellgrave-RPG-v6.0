...
local shop = { -- 4500 gps 1 Flame Token
	{id=36986, buy=4, sell=0, name='Mystic Essence'},
	{id=36987, buy=8, sell=0, name='Abyssal Essence'},
	{id=36988, buy=13, sell=0, name='Ascending Essence'},
	{id=36989, buy=18, sell=0, name='Chaos Essence'},
	{id=39226, buy=8, sell=0, name='Abyssal Crystal Fluid'},
	{id=39227, buy=16, sell=0, name='Ascending Crystal Fluid'},
	{id=39228, buy=34, sell=0, name='Chaos Crystal Fluid'},
...
local function onSell(cid, item, subType, amount, ignoreCap, inBackpacks)
	...
	if not ignoreCap and player:getFreeCapacity() < ItemType(itemsTable[item].id):getWeight(amount) then
		...
		if player:addItem(27312, amount* itemsTable[item].sell, amount* itemsTable[item].sell) then
			return player:sendTextMessage(MESSAGE_TRADE,
						"Sell "..amount.."x "..itemsTable[item].name.." for "..amount* itemsTable[item].sell.." Flame Tokens.")
end
return true
end
...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "Trade") then
		...
		npcHandler:say("You can buy some Chaos Materials for Flame Tokens.", cid)
	end
	return true
end
