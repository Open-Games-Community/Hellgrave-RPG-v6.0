...
local shop = { -- 10000 gps 1 Star Token
	{id=23704, buy=1, sell=0, name='Piece of Endless Crystal'},
	{id=27878, buy=1, sell=0, name='Piece of Divine Crystal'},
	{id=23705, buy=1, sell=0, name='Piece of Amber Crystal'},
	{id=36189, buy=2, sell=0, name='Rare Endless Crystal'},
	{id=36190, buy=2, sell=0, name='Rare Divine Crystal'},
	{id=36191, buy=2, sell=0, name='Rare Amber Crystal'},
	{id=36936, buy=4, sell=0, name='Mystic Book of Chaos'},
	{id=36937, buy=6, sell=0, name='Exotic Book of Chaos'},
	{id=36938, buy=8, sell=0, name='Legacy Book of Chaos'},
	{id=36939, buy=10, sell=0, name='Abyssal Book of Chaos'},
	{id=36940, buy=14, sell=0, name='Ascending Book of Chaos'},
...
local function onSell(cid, item, subType, amount, ignoreCap, inBackpacks)
	...
	if not ignoreCap and player:getFreeCapacity() < ItemType(itemsTable[item].id):getWeight(amount) then
		...
		if player:addItem(27305, amount* itemsTable[item].sell, amount* itemsTable[item].sell) then
			return player:sendTextMessage(MESSAGE_TRADE,
						"Sell "..amount.."x "..itemsTable[item].name.." for "..amount* itemsTable[item].sell.." Star Tokens.")
end
return true
end
...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "Trade") then
		...
		npcHandler:say("You can buy some parangon and chaos materials for star tokens.", cid)
	end
	return true
end
