local mType = Game.createMonsterType("Unsolicited")
local monster = {}

monster.description = "a Unsolicited"
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 30, type = COMBAT_FIREDAMAGE, minDamage = -100, maxDamage = -1220, range = 7, radius = 4, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true},
	{name ="firefield", interval = 2000, chance = 10, range = 7, radius = 4, shootEffect = CONST_ANI_FIRE, target = true},
	{name ="combat", interval = 2000, chance = 22, type = COMBAT_FIREDAMAGE, minDamage = -150, maxDamage = -1270, length = 8, spread = 3, effect = CONST_ME_FIREAREA, target = false}
}
