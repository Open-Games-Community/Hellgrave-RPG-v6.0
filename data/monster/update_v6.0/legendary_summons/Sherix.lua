local mType = Game.createMonsterType("Sherix")
local monster = {}

monster.description = "a Sherix"
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_FIREDAMAGE, minDamage = -200, maxDamage = -300, length = 8, spread = 3, effect = 243, target = false},
	{name ="combat", interval = 2000, chance = 5, type = COMBAT_DEATHDAMAGE, minDamage = -120, maxDamage = -500, length = 8, spread = 3, target = false},
