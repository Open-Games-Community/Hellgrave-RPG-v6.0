local mType = Game.createMonsterType("Lokness [****]")
local monster = {}

monster.description = "a Lokness [****]"
...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, skill = 170, attack = 180},
	{name ="combat", interval = 2000, chance = 7, type = COMBAT_DEATHDAMAGE, minDamage = -500, maxDamage = -1200, range = 7, shootEffect = 247, effect = CONST_ME_SOUND_RED, target = true},
	{name ="combat", interval = 2000, chance = 11, type = COMBAT_LIFEDRAIN, minDamage = -200, maxDamage = -1285, radius = 3, effect = CONST_ME_MAGIC_RED, target = false},
	{name ="seacrest serpent wave", interval = 2000, chance = 30, minDamage = 0, maxDamage = -1284, target = false},
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_PHYSICALDAMAGE, minDamage = -400, maxDamage = -1300, length = 4, spread = 3, effect = 238, target = false}
