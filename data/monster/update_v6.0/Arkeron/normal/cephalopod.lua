local mType = Game.createMonsterType("Cephalopod [****]")
local monster = {}

monster.description = "a Cephalopod [****]"
...
monster.loot = {
	...
	{name = "parchment of ancient writings", chance = 1500},
...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -500, maxDamage = -1200, condition = {type = CONDITION_POISON, totalDamage = 150, interval = 4000}},
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -400, maxDamage = -1800, range = 7, shootEffect = CONST_ANI_SUDDENDEATH, effect = CONST_ME_MORTAREA, target = false},
	{name ="speed", interval = 1000, chance = 6, speedChange = -400, range = 7, effect = CONST_ME_MAGIC_RED, target = false, duration = 20000},
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_ENERGYDAMAGE, minDamage = -1000, maxDamage = -2000, radius = 4, effect = 242, target = false}
