local mType = Game.createMonsterType("Ghoul Anomaly [****]")
local monster = {}

monster.description = "a Ghoul Anomaly [****]"
...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_LIFEDRAIN, minDamage = -350, maxDamage = -1400, range = 1, radius = 1, effect = 245, target = true},
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_DEATHDAMAGE, minDamage = -750, maxDamage = -1900, length = 8, spread = 3, effect = 202, target = true},
	{name ="combat", interval = 2000, chance = 10, type = COMBAT_MANADRAIN, minDamage = -480, maxDamage = -1200, radius = 4, effect = 246, target = false}
}
