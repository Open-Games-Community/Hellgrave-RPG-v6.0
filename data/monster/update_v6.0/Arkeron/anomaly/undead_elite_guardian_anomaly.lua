local mType = Game.createMonsterType("Undead Elite Guardian Anomaly [****]")
local monster = {}

monster.description = "a Undead Elite Guardian Anomaly [****]"
...
monster.attacks = {
	...
	{name ="combat", interval = 1500, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -400, maxDamage = -1550, range = 7, shootEffect = CONST_ANI_WHIRLWINDSWORD, target = false},
	{name ="combat", interval = 1000, chance = 15, type = COMBAT_LIFEDRAIN, minDamage = -600, maxDamage = -1900, range = 5, radius = 3, effect = CONST_ME_HITAREA, target = false}
}
