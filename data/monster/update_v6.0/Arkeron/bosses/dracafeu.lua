local mType = Game.createMonsterType("Dracafeu [*****]")
local monster = {}

monster.description = "a Dracafeu [*****]"
...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -500, maxDamage = -1707},
	{name ="combat", interval = 1000, chance = 11, type = COMBAT_DEATHDAMAGE, minDamage = -450, maxDamage = -1600, length = 8, spread = 3, effect = 236, target = false},
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_DEATHDAMAGE, minDamage = -400, maxDamage = -1300, radius = 4, effect = 237, target = false},
	{name ="combat", interval = 3000, chance = 18, type = COMBAT_PHYSICALDAMAGE, minDamage = -500, maxDamage = -1255, radius = 5, effect = 247, target = true},
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_FIREDAMAGE, minDamage = -450, maxDamage = -1900, radius = 6, shootEffect = CONST_ANI_FIRE, effect = 60, target = true}
}
