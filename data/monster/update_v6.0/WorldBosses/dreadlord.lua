local mType = Game.createMonsterType("Dreadlord")
local monster = {}

monster.description = "Dreadlord"
...
monster.voices = {
	interval = 5000,
	chance = 10,
	{text = "Huh, are you ready ?!", yell = true},
	{text = "Go ahead and increase your power!", yell = true},
...
monster.loot = {
	...
	{name = "infernatil helmet", chance = 2000},
	{id = 36833, chance = 1100},
	{id = 36831, chance = 1000},
	{id = 10165, chance = 1800},
}

monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -2000},
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_ENERGYDAMAGE, minDamage = -680, maxDamage = -1360, radius = 4, effect = 244, target = true},
	...
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_MANADRAIN, minDamage = -700, maxDamage = -900, radius = 4, effect = CONST_ME_MAGIC_RED, target = true},
	{name ="combat", interval = 2000, chance = 5, type = COMBAT_MANADRAIN, minDamage = -750, maxDamage = -750, radius = 5, effect = 253, target = true}
}
