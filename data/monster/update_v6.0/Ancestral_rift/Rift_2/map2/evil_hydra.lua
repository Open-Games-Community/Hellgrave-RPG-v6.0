local mType = Game.createMonsterType("Evil Hydra [2]")
local monster = {}

monster.description = "a evil hydra [2]"
...
monster.loot = {
	...
	{name = "albino plate", chance = 450},
	{name = "collar of green plasma", chance = 1450},
	{name = "sabretooth", chance = 1200, maxCount = 2},
	{name = "surprise backpack", chance = 250},
	{name = "rare rune powder", chance = 2000, maxCount = 3},
	{name = "pirate boots", chance = 1150},
	...
	{name = "dragon backpack", chance = 300},
	{name = "fragment endless crystal", chance = 400},
	{name = "salvage material", chance = 2500, maxCount = 3},
	{name = "light solar ore", chance = 1100, maxCount = 2},
	{name = "malachite ore", chance = 800, maxCount = 2},
...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -160, maxDamage = -450},
	{name ="combat", interval = 3000, chance = 20, type = COMBAT_FIREDAMAGE, minDamage = -150, maxDamage = -350, range = 7, radius = 4, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true},
	{name ="firefield", interval = 1000, chance = 10, range = 7, radius = 6, shootEffect = CONST_ANI_FIRE, target = true},
	{name ="combat", interval = 4000, chance = 20, type = COMBAT_FIREDAMAGE, minDamage = -150, maxDamage = -400, length = 8, spread = 3, effect = CONST_ME_FIREAREA, target = false}
}
