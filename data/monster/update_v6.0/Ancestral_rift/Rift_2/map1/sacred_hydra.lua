local mType = Game.createMonsterType("Sacred Hydra [2]")
local monster = {}

monster.description = "a sacred hydra [2]"
...
monster.loot = {
	...
	{name = "gold coin", chance = 60000, maxCount = 100},
	{name = "envenomed arrow", chance = 1690, maxCount = 25},
	{name = "tower shield", chance = 1250},
	{name = "hammer of wrath", chance = 200},
	{name = "crystal crossbow", chance = 350},
