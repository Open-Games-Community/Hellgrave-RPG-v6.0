...
GameStore.Categories = {
  {
      ...
      offers = {
           {
             icons = { "Portal_Scroll.png" },
             name = "Portal Scroll",
             state = GameStore.States.STATE_NEW,
             price = 50,
             itemtype = 42049,
             count = 1,
             description = "<i>Teleport from anywhere to the capital:</i>\n\n&#8226; Access from anywhere to the temple\n&#8226; You have 60 Seconds\n&#8226; Deposite, trade and go back to the teleport",
           ...
           },
           {
            ...
            itemtype = 42034,
            count = 1,
            description = "<i>Refill Your stamina:</i>\n\n&#8226; Refill Up to 2 hours of stamina",
            type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
            coinType = GameStore.CointType.Tournament,
            home = true,
          },
...
-- Potions
 ...
 -- Base outfit has addon = 0 or no defined addon. By default addon is set to 0.
 {
   ...
   offers = { 
        ...
        {
          icons = { "Outfit_Arbalester_Addon_3.png", "Outfit_Arbalester_Female_Addon_3.png" },
 ...
 { 
   ...
   offers = {
        ...
        },	
        {
          ...
          name = "Azazel Dress",
          price = 900,
          id = HIRELING_STORAGE.OUTFIT + HIRELING_OUTFITS.AZAZEL,
          count = 1,
          number = 1,
          description = "{info} can only be used for hirelings of the purchasing character\n{activated}\n{info} the purchased dress can be used by all hirelings, however, how many hirelings can wear this outfit at the same time depends on the number of dresses you own\n{info} number that can be purchased depends on the amount of hirelings you own",
          type = GameStore.OfferTypes.OFFER_TYPE_HIRELING_OUTFIT,
        ...
        {
          icons = { "Divine_Angel.png" },
          name = "Divine Angel Dress",
          price = 900,
          id = HIRELING_STORAGE.OUTFIT + HIRELING_OUTFITS.ANGEL,
          count = 1,
          number = 1,
          description = "{info} can only be used for hirelings of the purchasing character\n{activated}\n{info} the purchased dress can be used by all hirelings, however, how many hirelings can wear this outfit at the same time depends on the number of dresses you own\n{info} number that can be purchased depends on the amount of hirelings you own",
          type = GameStore.OfferTypes.OFFER_TYPE_HIRELING_OUTFIT,
        ...
        {
          icons = { "Monstor.png" },
          name = "The Monstor Dress",
          price = 900,
          id = HIRELING_STORAGE.OUTFIT + HIRELING_OUTFITS.MONSTOR,
          count = 1,
          number = 1,
          description = "{info} can only be used for hirelings of the purchasing character\n{activated}\n{info} the purchased dress can be used by all hirelings, however, how many hirelings can wear this outfit at the same time depends on the number of dresses you own\n{info} number that can be purchased depends on the amount of hirelings you own",
          type = GameStore.OfferTypes.OFFER_TYPE_HIRELING_OUTFIT,
  ...
  {   
   ...
   subclasses = {"Exclusive Offers"},
	...
	{ 
      ...
      offers = {
        {
          icons = { "Tournament_Coin.png" },
          name = "Tournament Coin",
          state = GameStore.States.STATE_NEW,
          price = 25,
          itemtype = 24275,
          count = 25,
          description = "Exchange your Tournament Coins into a transferable coin to sell it on Market or Trade.",
          type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
          coinType = GameStore.CointType.Tournament,
          home = true,
        },
        ...
        {
          icons = { "Outfit_Percht_Raider_Male_Addon_3.png", "Outfit_Percht_Raider_Female_Addon_3.png" },
        ...
        {
          icons = { "Outfit_Orcsoberfest_Garb_Male_Addon_3.png", "Outfit_Orcsoberfest_Garb_Female_Addon_3.png" },
        ...
        {
          icons = { "Outfit_Falconeer_Male_Addon_3.png", "Outfit_Falconeer_Female_Addon_3.png" },
          name = "Full Falconeer Outfit",
          price = 1100,
          state = GameStore.States.STATE_NEW,
        ...
        },
        {
          ...
          name = "Full Royal Bounacean Adivsor Outfit",
          price = 1200,
          state = GameStore.States.STATE_NEW,
