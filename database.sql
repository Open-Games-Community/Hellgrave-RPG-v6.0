...
CREATE TABLE IF NOT EXISTS `accounts` (
  ...
  `tournamentBalance`     int(11)       UNSIGNED NOT NULL DEFAULT '0',
...
(2, 'Mage Sample', 1, 1, 8, 1, 185, 185, 4200, 113, 115, 95, 39, 129, 0, 90, 90, 0,    1, '', 470, 1, 10, 0,   10, 0,   10,  0,  10, 0),
(3, 'Priest Sample',    1, 1, 8, 2, 185, 185, 4200, 113, 115, 95, 39, 129, 0, 90, 90, 0,    1, '', 470, 1, 10, 0,   10, 0,   10,  0,  10, 0),
(4, 'Hunter Sample',  1, 1, 8, 3, 185, 185, 4200, 113, 115, 95, 39, 129, 0, 90, 90, 0,    1, '', 470, 1, 10, 0,   10, 0,   10,  0,  10, 0),
(5, 'Warrior Sample',   1, 1, 8, 4, 185, 185, 4200, 113, 115, 95, 39, 129, 0, 90, 90, 0,    1, '', 470, 1, 10, 0,   10, 0,   10,  0,  10, 0),
