...
void mainLoader(int, char*[], ServiceManager* services) {
	...
	SPDLOG_INFO("A server developed by (Updates https://forums.otserv.com.br): {}", STATUS_SERVER_DEVELOPERS);
	SPDLOG_INFO("Hellgrave RPG Server, to check updates visit our forum: "
		"https://opengamescommunity.com");
	SPDLOG_INFO("Official Website: https://hellgrave.com");
	SPDLOG_INFO("A Website & Launcher is available (paid) here: https://opengamescommunity.com");
	...
	SPDLOG_INFO("Loaded main modules");
	SPDLOG_INFO("Custom Scripts Loaded, server starting...");
	SPDLOG_INFO("Server version v6.0 Loaded, for updates check https://opengamescommunity.com");
	SPDLOG_INFO("Custom ZnoteAAC v6 + Wiki / Launcher/Updater Hellgrave v6 available: https://opengamescommunity.com");
	SPDLOG_INFO("For any trouble conecting with server, please visit our forum and ask on Support category.");
