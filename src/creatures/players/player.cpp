...
bool Player::updateSaleShopList(const Item* item)
{
	...
	uint16_t itemId = item->getID();
	if ((currency == ITEM_GOLD_COIN && itemId != ITEM_GOLD_COIN && itemId != ITEM_PLATINUM_COIN && itemId != ITEM_CRYSTAL_COIN && itemId != ITEM_AMBER_COIN && itemId != ITEM_DEMONIAC_COIN) || (currency != ITEM_GOLD_COIN && itemId != currency)) {
