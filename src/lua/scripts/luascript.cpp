...
void LuaScriptInterface::registerFunctions()
{
  ...
  registerEnum(CONST_ME_ROOTS)
	...
	registerEnum(CONST_ANI_BURSTARROW)
		registerEnum(CONST_ANI_THORNARROW)
		registerEnum(CONST_ANI_THORNBOLT)
		registerEnum(CONST_ANI_SPURARROW)
		registerEnum(CONST_ANI_SPURBOLT)
	...
	registerEnum(ITEM_TOURNAMENT_COIN)
	...
	registerEnum(BESTY_RACE_RIFT)
	registerEnum(BESTY_RACE_CHAOS)
  ...
  registerEnum(WEAPON_QUIVER)
	...
	registerEnum(AMMO_SPUR_ARROW)
	registerEnum(AMMO_THORN_ARROW)
	registerEnum(AMMO_THORN_BOLT)
	registerEnum(AMMO_SPUR_BOLT)
...
int LuaScriptInterface::luaWeaponAmmoType(lua_State* L)
{
	...
	if (weapon) {
		...
		else if (type == "spurarrow") {
			it.ammoType = AMMO_SPUR_ARROW;
		}
		else if (type == "thornarrow") {
			it.ammoType = AMMO_THORN_ARROW;
		}
		else if (type == "spurbolt") {
			it.ammoType = AMMO_SPUR_BOLT;
		}
		else if (type == "thornbolt") {
			it.ammoType = AMMO_THORN_BOLT;
		}
		else {
