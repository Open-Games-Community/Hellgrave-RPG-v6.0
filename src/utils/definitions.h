...
static constexpr auto STATUS_SERVER_NAME = "Hellgrave RPG";
static constexpr auto STATUS_SERVER_VERSION = "TFS 1.3";
static constexpr auto STATUS_SERVER_DEVELOPERS = "OTServBR-Global Team, Mark Samman and The Forgotten Server Developers. Edited by OpenGamesCommunity.";
