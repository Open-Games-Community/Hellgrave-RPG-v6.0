...
def do_login(data):
    ...
    try:
        ...
        players = []
        vocations = ['None', 'Mage', 'Priest', 'Hunter', 'Warrior', 'Elite Mage', 'Elite Priest', 'Elite Hunter', 'Elite Warrior', 'Mage Dawnport', 'Priest Dawnport', 'Hunter Dawnport', 'Warrior Dawnport']
        ...
        playdata = {
            'worlds': [
                {
                    'id': 0,
                    'name': os.getenv('SERVER_NAME', 'Hellgrave'),
